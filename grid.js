	...
	*/
	...
	recto_columns() {
		...
		for (let i = 0; i < this.props.columns; i++) {
			...
			const x = this.half_page().x
				+ this.props.margin.inside
				+ (i * this.props.gutter) + i * this.column_width();
	...
	half_page() {
		return {
			x: this.props.spread_width / 2,
			y: this.props.spread_height / 2
		}
	}
}
